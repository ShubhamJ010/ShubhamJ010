...
<p style="font-family: 'Comic Sans MS', 'Comic Sans', cursive; font-size: 12px; margin-top: 2px; text-align: center;">click ascii for resume</p>
...
<p style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
  <img alt="Java" height="36" src="https://www.svgrepo.com/show/353924/java.svg" />
  <img alt="TypeScript" height="36" src="https://www.svgrepo.com/show/374146/typescript-official.svg" />
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 70" width="50" height="44" style="vertical-align: middle;">
    ...
    <g>
      <ellipse data-name="Right Blush" cx="53.22" cy="40.18" rx="5.85" ry="3.44" style="fill:#febbd0"/>
      ...
      <path d="M24 33.64a2.07 2.07 0 1 0-2.06-2.07A2.07 2.07 0 0 0 24 33.64Zm24.77 0a2.07 2.07 0 1 0-2.06-2.07 2.07 2.07 0 0 0 2.04 2.07Z" style="fill:#fff;fill-rule:evenodd"/>
    </g>
  </svg>
